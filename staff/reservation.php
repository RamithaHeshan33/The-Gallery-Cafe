        ...
        <div class="container">
            ...
            <div class="form-container-2">
                <div class="form-content">
                    ...
                    <a href="table-reservation.php"><input type="button" value="Check Now" id="reserveTableBtn" class="btn2"></a>
                </div>
            </div>
            ...
            <div class="form-container-2">
                <div class="form-content">
                    <form method="POST" action="parking-res.php">
                        ...
                        <a href="park-reservation.php"><input type="button" value="Check Now" id="reserveParkingBtn" class="btn2"></a>
                    </form>
                </div>
            </div>
        </div>
