    ...
    <div class="parking">
        <div class="slot-group">
            ...
            <div class="slot user">
                ...
                <a href="user_profiles.php"><input type="button" value="Visit Page" class="btn2"></a>
            ...
            <div class="slot table">
                ...
                <a href="table-reservation.php"><input type="button" value="Visit Page" class="btn2"></a>
            ...
            <div class="slot member">
                ...
                <a href="staff.php"><input type="button" value="Visit Page" class="btn2"></a>
            ...
            <div class="slot food">
                ...
                <a href="order.php"><input type="button" value="Visit Page" class="btn2"></a>
